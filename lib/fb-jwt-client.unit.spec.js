...
test('When a get request results in an error and a logger instance has been provided', async t => {
  ...
  try {
    ...
    t.deepEquals(callArgs[1], 'Error: FBJWTClient: Error - 400 - boom - {"name":"e.error.name","message":"bang!","code":400}', 'it should generate a message explaining the error')
  }
  gotStub.restore()
})
...
test('When a post request results in an error and a logger instance has been provided', async t => {
  ...
  try {
    ...
    t.deepEquals(callArgs[1], 'Error: FBJWTClient: Error - 400 - boom - ', 'it should generate a message explaining the error')
  }
  gotStub.restore()
})
