...
test('When calling an endpoint successfully', async t => {
  ...
  await nockedClient.send('get', '/route', {}, {})

  t.deepEqual(apiMetricsStartTimerStub.getCall(0).args[0], {client_name: 'FBJWTClient',
    baseUrl: 'http://testdomain',
    url: '/route',
    method: 'get'}, 'it should start the instrumentation timer with the correct args')
  ...
  t.deepEqual(requestMetricsStartTimerStub.getCall(0).args[0], {client_name: 'FBJWTClient',
    baseUrl: 'http://testdomain',
    url: '/route',
    method: 'get'}, 'it should start the instrumentation timer with the correct args')
...
test('When retrying an endpoint', async t => {
  ...
  try {
    await nockedClient.send('get', '/missing', {}, {}, {retry: {retries}})
  } catch (e) {
    //
  }
  ...
  t.deepEqual(requestMetricsStartTimerStub.getCall(1).args[0], {client_name: 'FBJWTClient',
    baseUrl: 'http://testdomain',
    url: '/missing',
    method: 'get'}, 'it should start the instrumentation timer with the correct args')
